...
- 👨‍🎓 I'm Software Engineering - II & Student in Universidade Federal do Mato Grosso do Sul, Brazil.
- :man_technologist: Stack's Developer -> Go Lang (Gin/gRPC) | Typescript & JavaScript | React & Vue | Next.js & Vite | Node.Js | Api-REST & Graphql & WebSocket | Docker | Kubernets | Apache Kafka | PostgreSQL & MySQL | RabbitMQ | JWT, OAuth2, Keycloak | Linux / Unix & MacOS | GoF Design Patterns | UI/UX - Figma Designer | CI/CD - GitOps | Front-end Software Architect & Design | Product Manager |
#
### Links 🖥️
